  ...
  return (
    <>
      ...
      <main className="bg-white">
        <HomeBanner
          eyebrow="Doctor / Distributor Enquiry Portal"
          title={`Submit your enquiry to \nAspen Pharmaceuticals.`}
          description="Use the form below to share details for product enquiries, franchise enquiries, or distributor applications. Our team will review and respond professionally."
        />
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:px-8 lg:grid-cols-[0.8fr_1.2fr] lg:px-10 lg:py-24">
            ...
            <form className="grid gap-4 rounded-sm border border-slate-200 p-6 sm:grid-cols-2">
              ...
              <input
                ...
                aria-label="Organization or clinic"
              />
              <textarea
                className="min-h-32 rounded-sm border border-slate-200 px-4 py-4 text-sm outline-none focus:border-[#0F8B8D] sm:col-span-2"
                placeholder="Message"
                aria-label="Message"
              />
              <button
                type="button"
                className="rounded-sm bg-[#0B3C6D] px-6 py-4 text-sm font-semibold text-white hover:bg-[#082f56] sm:col-span-2">
                Submit Enquiry
              </button>
            </form>
          </div>
